...
public:
    ...
    {
        MainView->setWindowTitle(QApplication::translate("MainView", "Dialog", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabRead), QApplication::translate("MainView", "Read", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabCreate), QApplication::translate("MainView", "Create", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabUpdate), QApplication::translate("MainView", "Update", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabDelete), QApplication::translate("MainView", "Delete", nullptr));
    } // retranslateUi
